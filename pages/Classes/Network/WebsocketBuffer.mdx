...
The Network.WebsocketBuffer instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Network.WebsocketBuffer instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Network.WebsocketBuffer instance has no set functions!
