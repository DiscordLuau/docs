...
The Network.DiscordGateway instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Network.DiscordGateway instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Network.DiscordGateway instance has no set functions!
