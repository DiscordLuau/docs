...
The Network.DiscordVoiceConnection instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Network.DiscordVoiceConnection instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Network.DiscordVoiceConnection instance has no set functions!
