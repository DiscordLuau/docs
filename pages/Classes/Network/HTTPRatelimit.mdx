...
The Network.HTTPRatelimit instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Network.HTTPRatelimit instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Network.HTTPRatelimit instance has no set functions!
