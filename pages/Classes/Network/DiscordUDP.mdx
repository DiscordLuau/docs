...
The Network.DiscordUDP instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Network.DiscordUDP instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Network.DiscordUDP instance has no set functions!
