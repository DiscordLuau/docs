...
The Network.DiscordWebsocket instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Network.DiscordWebsocket instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Network.DiscordWebsocket instance has no set functions!
