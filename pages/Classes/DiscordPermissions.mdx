...
The DiscordPermissions instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The DiscordPermissions instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The DiscordPermissions instance has no set functions!
