...
> DiscordIntents.new( `intentList` [\{ string }](https://www.lua.org/pil/2.4.html) ) ->  DiscordIntents 
...
> DiscordIntents.fromDefault() ->  DiscordIntents 
...
> DiscordIntents.fromAll() ->  DiscordIntents 
