...
The Interface.TextInputComponent instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Interface.TextInputComponent instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Interface.TextInputComponent instance has no set functions!
