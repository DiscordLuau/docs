...
The Interface.ButtonComponent instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Interface.ButtonComponent instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Interface.ButtonComponent instance has no set functions!
