...
The Interface.SelectionComponent instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Interface.SelectionComponent instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Interface.SelectionComponent instance has no set functions!
