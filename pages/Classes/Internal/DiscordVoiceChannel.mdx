...
The Internal.DiscordVoiceChannel instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Internal.DiscordVoiceChannel instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Internal.DiscordVoiceChannel instance has no set functions!
