...
The Internal.DiscordApplication instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Internal.DiscordApplication instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Internal.DiscordApplication instance has no set functions!
