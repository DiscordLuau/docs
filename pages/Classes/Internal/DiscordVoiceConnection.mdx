...
# Internal.DiscordVoiceConnection
...
The Internal.DiscordVoiceConnection instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Internal.DiscordVoiceConnection instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Internal.DiscordVoiceConnection instance has no set functions!
