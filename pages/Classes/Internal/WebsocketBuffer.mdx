...
The Internal.WebsocketBuffer instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Internal.WebsocketBuffer instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Internal.WebsocketBuffer instance has no set functions!
