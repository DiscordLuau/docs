...
The Internal.DiscordUDP instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Internal.DiscordUDP instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Internal.DiscordUDP instance has no set functions!
