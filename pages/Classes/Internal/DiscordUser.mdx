...
The Internal.DiscordUser instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Internal.DiscordUser instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Internal.DiscordUser instance has no set functions!
