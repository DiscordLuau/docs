...
The Internal.DiscordGuildMember instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Internal.DiscordGuildMember instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Internal.DiscordGuildMember instance has no set functions!
