...
The Internal.HTTPRatelimit instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The Internal.HTTPRatelimit instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The Internal.HTTPRatelimit instance has no set functions!
