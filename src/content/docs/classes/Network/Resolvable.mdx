...
> <LuaDeclaration
>   name="headers"
>   className="Resolvable"
>   args={[]}
>   returnType="{ [string]: string }"
>   isMethod
> />
> Returns a dictionary of headers this resolvable requires in order to successfuly
> be processed by the Discord API
...
>   isMethod
> />
> Resolves the data that this Resolvable has, for instance - if this data is JSON,
> it will be thrown through the EventIn pre-processor.
...
>   name="new"
>   className="Resolvable"
>   args={[{ name: "threadCount", type: "number?" }]}
> />
