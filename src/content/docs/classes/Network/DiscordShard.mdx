...
>   name="heartbeatAsync"
>   className="DiscordShard"
>   args={[{ name: "ignoreHeartbeatAck", type: "boolean?" }]}
>   returnType="Future"
>   isMethod
> />
...
>   name="heartbeatIn"
>   className="DiscordShard"
>   args={[{ name: "milliseconds", type: "number" }]}
>   isMethod
> />
...
>   name="connectAsync"
>   className="DiscordShard"
>   args={[{ name: "websocketUrl", type: "string" }]}
>   returnType="Future"
>   isMethod
> />
