...
> <LuaDeclaration
> 	name="parseDiscordAPIErrors"
> 	className="DiscordGateway"
> 	args={[
> 		{ name: "api", type: "string" },
> 		{ name: "networkResponse", type: "Net.FetchResponse" },
> 	]}
> 	returnType="string"
> 	isMethod
> />
...
> <LuaDeclaration
> 	name="setEndpointCache"
> 	className="DiscordGateway"
> 	args={[
> 		{ name: "endpoint", type: "string" },
> 		{ name: "cache", type: "table" },
> 	]}
> 	isMethod
> />
