...
description: DiscordLuau docs for ButtonComponent.
---
...
The ButtonComponent instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The ButtonComponent instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The ButtonComponent instance has no set functions!
