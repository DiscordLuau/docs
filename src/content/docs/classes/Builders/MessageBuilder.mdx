...
> <LuaDeclaration name="setFlags" className="MessageBuilder" args={[ { name: "fileContent", type: "string" }, { name: "fileName", type: "string" } ]} returnType="Builders.MessageBuilder" isMethod />
Sets the flags for the message.
### toJsonObject
...
> <LuaDeclaration name="toFormdataObject" className="MessageBuilder" args={[  ]} returnType="string" isMethod />
