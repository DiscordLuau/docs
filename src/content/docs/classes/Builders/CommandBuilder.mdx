...
>   args={[{ name: "commandType", type: "number" }]}
...
> <LuaDeclaration
>   name="setGuildPermissions"
>   className="CommandBuilder"
>   args={[{ name: "permissionObject", type: "PermissionsBuilder" }]}
>   returnType="Builders.CommandBuilder"
>   isMethod
> />
...
>   name="addOption"
>   className="CommandBuilder"
>   args={[{ name: "commandObject", type: "CommandOptionBuilder" }]}
>   returnType="Builders.CommandBuilder"
>   isMethod
> />
