...
> <LuaDeclaration
>   name="addActivity"
>   className="PresenceBuilder"
>   args={[{ name: "activity", type: "ActivityBuilder" }]}
>   returnType="Builders.PresenceBuilder"
>   isMethod
> />
