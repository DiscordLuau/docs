...
> <LuaDeclaration
> 	name="setStyle"
> 	className="ButtonBuilder"
> 	args={[{ name: "buttonStyle", type: "number" }]}
> 	returnType="Builders.Interface.ButtonBuilder"
> 	isMethod
> />
...
> 	name="setLabel"
> 	className="ButtonBuilder"
> 	args={[{ name: "buttonLabel", type: "string" }]}
> 	returnType="Builders.Interface.ButtonBuilder"
> 	isMethod
> />
...
> 	isMethod
> />
> Sets the URL for the button. This should only be used if the button style is set
> to `Link`.
...
> 	name="new"
> 	className="ButtonBuilder"
> 	args={[{ name: "buttonId", type: "string" }]}
> />
