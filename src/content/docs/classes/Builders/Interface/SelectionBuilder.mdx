...
> <LuaDeclaration
>   name="setType"
>   className="SelectionBuilder"
>   args={[{ name: "selectionType", type: "number" }]}
>   returnType="Builders.Interface.SelectionBuilder"
>   isMethod
> />
...
>   name="setPlaceholder"
>   className="SelectionBuilder"
>   args={[{ name: "placeholderText", type: "string" }]}
>   returnType="Builders.Interface.SelectionBuilder"
>   isMethod
> />
...
>   name="setDisabled"
>   className="SelectionBuilder"
>   args={[{ name: "isDisabled", type: "boolean" }]}
>   returnType="Builders.Interface.SelectionBuilder"
>   isMethod
> />
...
>     { name: "choiceValue", type: "string" },
>     { name: "choiceDescription", type: "string" },
...
>   name="destroyChoice"
>   className="SelectionBuilder"
>   args={[{ name: "choiceName", type: "string" }]}
>   returnType="Builders.Interface.SelectionBuilder"
>   isMethod
> />
...
>   name="new"
>   className="SelectionBuilder"
>   args={[{ name: "selectionId", type: "string" }]}
> />
