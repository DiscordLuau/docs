...
> <LuaDeclaration
>   name="setDiscordToken"
>   className="SettingsBuilder"
>   args={[{ name: "discordToken", type: "string" }]}
>   returnType="Builders.SettingsBuilder"
>   isMethod
> />
...
>   name="setIntents"
>   className="SettingsBuilder"
>   args={[{ name: "discordIntents", type: "IntentsBuilder" }]}
>   returnType="Builders.SettingsBuilder"
>   isMethod
> />
...
>   className="SettingsBuilder"
>   args={[
>     { name: "discordToken", type: "string" },
>     { name: "discordIntents", type: "IntentsBuilder?" },
>   ]}
> />
