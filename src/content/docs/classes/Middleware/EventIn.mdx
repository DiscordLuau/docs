...
> <LuaDeclaration name="toCamelCase" className="EventIn" isMethod args={[ { name: "self", type: "EventIn" }, { name: "json", type: "table" } ]}/>
Converts JSON keys from snake_case to camelCase.
### processJSON

> <LuaDeclaration name="processJSON" className="EventIn" isMethod args={[ { name: "self", type: "EventIn" }, { name: "data", type: "any" } ]}/>
Processes incoming JSON data, converting keys to camelCase if the data is a table.
### new

> <LuaDeclaration name="new" className="EventIn" isMethod args={[  ]}/>
