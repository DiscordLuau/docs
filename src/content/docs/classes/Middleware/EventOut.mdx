...
> <LuaDeclaration name="processJSON" className="EventOut" isMethod args={[ { name: "self", type: "EventOut" }, { name: "data", type: "any" } ]}/>
Processes outgoing JSON data. Currently, this method returns the data unchanged.
### new

> <LuaDeclaration name="new" className="EventOut" isMethod args={[  ]}/>
