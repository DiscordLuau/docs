...
> <LuaDeclaration name="createSlashCommandAsync" className="Application" args={[ { name: "self", type: "Application" }, { name: "slashCommand", type: "builders.interactionJSON" } ]} />
...
> <LuaDeclaration name="deleteSlashCommandAsync" className="Application" args={[ { name: "self", type: "Application" }, { name: "slashCommandId", type: "apiTypes.Snowflake" } ]} />

Delete an existing global application command.

### editSlashCommandAsync

> <LuaDeclaration name="editSlashCommandAsync" className="Application" args={[ { name: "self", type: "Application" }, { name: "slashCommandId", type: "apiTypes.Snowflake" }, { name: "slashCommand", type: "builders.interactionJSON" } ]} />

Edit an existing global application command.

### getSlashCommandsAsync

> <LuaDeclaration name="getSlashCommandsAsync" className="Application" args={[ { name: "self", type: "Application" }, { name: "withLocalizations", type: "boolean?" } ]} />

Get a list of global application commands.

### overwriteSlashCommandsAsync

> <LuaDeclaration name="overwriteSlashCommandsAsync" className="Application" args={[ { name: "self", type: "Application" }, { name: "slashCommands", type: "{ builders.interactionJSON }" } ]} />
