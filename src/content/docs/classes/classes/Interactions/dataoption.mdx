...
<LuaSummary className="DataOption" properties={[ { name: "type", type: "ApplicationCommandOptionType" }, { name: "options", type: "{Classes.Interactions.DataOption}?" }, { name: "name", type: "string" }, { name: "value", type: "T?" }, { name: "focused", type: "boolean?" } ]} />
