...
The DiscordInteraction instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The DiscordInteraction instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The DiscordInteraction instance has no set functions!
