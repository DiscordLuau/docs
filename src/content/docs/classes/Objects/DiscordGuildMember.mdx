...
The DiscordGuildMember instance has no set properties!

[//]: # (----- DOCUMENT METHODS ----- )

## Methods

The DiscordGuildMember instance has no set methods!

[//]: # (----- DOCUMENT FUNCTIONS ----- )

## Functions

The DiscordGuildMember instance has no set functions!
